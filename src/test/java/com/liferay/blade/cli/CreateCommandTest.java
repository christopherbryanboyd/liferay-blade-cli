...
public class CreateCommandTest {
	...
	public void testCreateActivator() throws Exception {
		...
		verifyImportPackage(Paths.get(projectPath + "/build/libs/bar.activator-1.0.0.jar").toFile());
		...
		verifyImportPackage(Paths.get(projectPath + "/target/bar-activator-1.0.0.jar").toFile());
	}
	...
	public void testCreateApi() throws Exception {
		...
		try (Jar jar = new Jar(Paths.get(projectPath + "/build/libs/foo-1.0.0.jar").toFile())) {
			assertEquals(
		...
		verifyImportPackage(Paths.get(projectPath + "/target/foo-1.0.0.jar").toFile());
	...
	public void testCreateGradleServiceBuilderDashes() throws Exception {
		...
		verifyImportPackage(Paths.get(projectPath + "/backend-integration-service/build/libs/com.liferay.backend.integration.service-1.0.0.jar").toFile());
	}
	...
	public void testCreateGradleServiceBuilderDots() throws Exception {
		...
		verifyImportPackage(Paths.get(projectPath + "/com.liferay.docs.guestbook-service/build/libs/com.liferay.docs.guestbook.service-1.0.0.jar").toFile());
	}
	...
	public void testCreateWorkspaceGradleFragment() throws Exception {
		...
		verifyImportPackage(Paths.get(projectPath + "/loginHook/build/libs/loginhook-1.0.0.jar").toFile());
	}
	...
	public void testCreateWorkspaceGradlePortletProject() throws Exception {
		...
		verifyImportPackage(Paths.get(projectPath + "/gradle.test/build/libs/gradle.test-1.0.0.jar").toFile());
	}
	...
	public void testCreateWorkspaceGradleServiceBuilderProjectApiPath()
		...
		verifyImportPackage(Paths.get(projectPath + "/sample/sample-service/build/libs/com.liferay.sample.service-1.0.0.jar").toFile());
	}
	...
	public void testCreateWorkspaceGradleServiceBuilderProjectDashes()
		...
		verifyImportPackage(Paths.get(projectPath + "/workspace-sample/workspace-sample-service/build/libs/com.sample.service-1.0.0.jar").toFile());
	}
	...
	public void testCreateWorkspaceModuleLocation() throws Exception {
		...
		verifyImportPackage(Paths.get(projectPath + "/foo/build/libs/foo-1.0.0.jar").toFile());
	}
