...
public class InstallTemplateCommand extends BaseCommand<InstallTemplateCommandArgs>{
	...
	public static final String DESCRIPTION = "Installs a project template into Blade.";
	...
	public void execute() throws Exception {
		...
		if (Files.exists(pathArg)) {
			if (Files.isDirectory(pathArg)) {
				...
				if (_isTemplateMatch(pathArg)) {
					_installTemplate(pathArg);
				}
			}
		}
		else {
	...
	private static void _installTemplate(Path templatePath) throws IOException {
